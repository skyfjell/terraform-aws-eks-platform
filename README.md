...
| <a name="input_config_karpenter"></a> [config\_karpenter](#input\_config\_karpenter) | Karpenter Configuration | <pre>object({<br>    install             = optional(bool, true)<br>    enable_provisioners = optional(bool, true)<br>  })</pre> | `{}` | no |
